...
$TCA['tx_ftfevents_domain_model_calendar'] = array(
	'ctrl' => $TCA['tx_ftfevents_domain_model_calendar']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_ftfevents_domain_model_calendar.pid=###CURRENT_PID### AND tx_ftfevents_domain_model_calendar.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:ftf_events/Resources/Private/Language/locallang_db.xml:tx_ftfevents_domain_model_calendar.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
